...
const Navbar = () => {
  ...
  return (
    <nav className="navbar">
      ...
      <Link to="/Login"><button class="custom-btn btn-3"><span>Login <LoginIcon/></span></button></Link>
      ...
      <div className="navbar__hamburger" onClick={handleHamburgerClick}>
        ...
        {isHamburgerOpen && (
          <div className="navbar__hamburger-links">
            ...
            <Link to="/Login"><button className="custom-btn btn-3"><span>Login <LoginIcon/></span></button></Link>
        <Link to="/Signin"><button className="custom-btn btn-3"><span>Sign Up <LockOpenIcon/></span></button></Link>
          </div>
        )}
      </div>
    </nav>
